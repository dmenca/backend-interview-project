...
import com.demnca.java.basic.proxy.vo.TargetObject;
...
public class Test1 {
    public static void main(String[] args) throws Exception {
        ...
        Class  c2 = Class.forName("com.demnca.java.basic.proxy.vo.Cat");
        // 3. 通过对象实例的getClass方法获取
        Cat cat3 = new Cat();
        Class c3 = cat3.getClass();

        //4. 通过类加载器的方式获取，通过类加载器的方式不会对Class对象进行初始化，也就是不会执行初始化、静态代码块、静态对象函数
        Class c4 = ClassLoader.getSystemClassLoader().loadClass("com.demnca.java.basic.proxy.vo.Cat");
        ...
        // 通过Class对象来创建实例
        Class<?> targetClass = Class.forName("com.demnca.java.basic.proxy.vo.TargetObject");
